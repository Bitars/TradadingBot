...
class RealTimeTradeBot:
    ...
    def main_engine(self):
        ...
        self.simulate_trading('BTC_USD.csv')
        self.simulate_trading('ETH_USD.csv')
        self.show_profit()
    ...
    def show_profit(self):
        ...
        if 'ETH' in self._stacks and self._stacks['ETH'] > 0:
            usdt_value += self._stacks['ETH'] * self.get_last_close_price('ETH_USD.csv')
        if 'BTC' in self._stacks and self._stacks['BTC'] > 0:
            usdt_value += self._stacks['BTC'] * self.get_last_close_price('BTC_USD.csv')

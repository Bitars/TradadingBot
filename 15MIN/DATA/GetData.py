...
# Example usage
start_time = int(pd.Timestamp('2024-06-01').timestamp() * 1000)
end_time = int(pd.Timestamp('2024-06-10').timestamp() * 1000)
df = get_binance_klines('BTCUSDT', '15m', start_time, end_time)
save_to_csv(df, 'BTC_USD.csv')
